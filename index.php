<?php
require_once('sistema/conection.php')//chamando a conexão com banco
?>
<!DOCTYPE html>
<html lang="pt-br">

<head>
  <title><?php echo $nome_sistema ?></title> <!--Trazendo o nome do banco-->
  <meta charset="utf-8" />
  ...
  <link rel="shortcut icon" type="image/x-icon" href="sistema/img/icon.png">
...
<body>
<!--ENTRANDO COM O ESILO AQUI PARA CARREAR A COR EM UMA VARIAVEL-->
<style type="text/css">
