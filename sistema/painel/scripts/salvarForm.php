...
/*quando queremos passar imput para o banco de dados devemos USAR O NAME E NÃO O ID*/
...
if(@$_FILES['logo']['name'] != "")
{                 
    $ext = pathinfo($nome_img, PATHINFO_EXTENSION);//pathinfo — Retorna informações sobre um caminho de arquivo
...
//SCRIPT PARA SUBIR FOTO NO SERVIDOR (pasta apenas troca as imagem detro da pasta IMG)
$nome_img = 'icone.png';
$caminho = '../../img/'.$nome_img;//caminho da pasta imagem
