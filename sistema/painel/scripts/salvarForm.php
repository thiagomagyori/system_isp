...
$pdo->query("UPDATE config SET username = '$adm_campo', nome = '$nome_campo', email = '$email_campo', senha = '$senha_campo', telefone = '$telefone_campo', endereco = '$endereco_campo', facebook = '$facebook_campo', youtube = '$youtube_campo', instagram = '$instagram_campo', twitter = '$twitter_campo'");
